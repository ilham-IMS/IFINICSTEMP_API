...
{
  public class InterfaceAgreementIncentiveMarketing : BaseModel
  {
    ...
    public List<InterfaceAgreementFee>? AgreementFees { get; set; }
    public List<InterfaceAgreementRefund>? AgreementRefunds { get; set; }
