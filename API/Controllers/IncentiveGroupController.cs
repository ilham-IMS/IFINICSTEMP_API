...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class IncentiveGroupController : BaseController
  {
    private readonly IIncentiveGroupService _service;

    public IncentiveGroupController(IIncentiveGroupService service, IConfiguration configuration) : base(configuration)
    {
      _service = service;
    }
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert(IncentiveGroup module)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID(IncentiveGroup module)
    {
      try
      {
    ...
    [HttpPut("ChangeStatus")]
		public async Task<ActionResult> ChangeStatus(IncentiveGroup model)
		{
			try
			{
