...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class SysDocumentNumberController : BaseController
  {
    private readonly ISysDocumentNumberService _service;

    public SysDocumentNumberController(ISysDocumentNumberService service, IConfiguration configuration) : base(configuration)
    {
      _service = service;
    }
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert(SysDocumentNumber module)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID(SysDocumentNumber module)
    {
      try
      {
