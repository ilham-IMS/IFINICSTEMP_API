...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class IncentiveGroupPositionController : BaseController
  {
    private readonly IIncentiveGroupPositionService _service;

    public IncentiveGroupPositionController(IIncentiveGroupPositionService service, IConfiguration configuration) : base(configuration)
    {
      _service = service;
    }
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert(IncentiveGroupPosition module)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID(List<IncentiveGroupPosition> module)
    {
      try
      {
