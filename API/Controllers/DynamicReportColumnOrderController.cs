...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class DynamicReportColumnOrderController : BaseController
  {
    private readonly IDynamicReportColumnOrderService _service;

    public DynamicReportColumnOrderController(
        IDynamicReportColumnOrderService service,
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert([FromBody] List<DynamicReportColumnOrder> models)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID([FromBody] List<DynamicReportColumnOrder> models)
    {
      try
      {
    ...
    [HttpPut("OrderUp")]
    public async Task<ActionResult> OrderUp([FromBody] DynamicReportColumnOrder model)
    {
      try
      {
    ...
    [HttpPut("OrderDown")]
    public async Task<ActionResult> OrderDown([FromBody] DynamicReportColumnOrder model)
    {
      try
      {
