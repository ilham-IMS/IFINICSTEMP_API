...
namespace API.Controllers
{
  ...
  {
    private readonly IIncentiveSchemeService _service;

    public IncentiveSchemeController(IIncentiveSchemeService service, IConfiguration configuration) : base(configuration)
    {
      _service = service;
    }
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert(IncentiveScheme module)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID(IncentiveScheme module)
    {
      try
      {
    ...
    [HttpPut("ChangeStatus")]
		public async Task<ActionResult> ChangeStatus(IncentiveScheme model)
		{
			try
			{
