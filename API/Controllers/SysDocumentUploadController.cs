...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class SysDocumentUploadController : BaseController
  {
    private readonly ISysDocumentUploadService _service;

    public SysDocumentUploadController(ISysDocumentUploadService service, IConfiguration configuration) : base(configuration)
    {
      _service = service;
    }
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert(SysDocumentUpload module)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID(SysDocumentUpload module)
    {
      try
      {
