...
namespace API.Controllers
{
  ...
  [DecryptQueryString]
	[DecryptRequestBody]
  public class DynamicReportColumnController : BaseController
  {
    private readonly IDynamicReportColumnService _service;

    public DynamicReportColumnController(
        IDynamicReportColumnService service,
    ...
    [HttpPost("Insert")]
    public async Task<ActionResult> Insert([FromBody] List<DynamicReportColumn> models)
    {
      try
      {
    ...
    [HttpPut("UpdateByID")]
    public async Task<ActionResult> UpdateByID([FromBody] List<DynamicReportColumn> models)
    {
      try
      {
    ...
    [HttpPut("OrderUp")]
    public async Task<ActionResult> OrderUp([FromBody] DynamicReportColumn model)
    {
      try
      {
    ...
    [HttpPut("OrderDown")]
    public async Task<ActionResult> OrderDown([FromBody] DynamicReportColumn model)
    {
      try
      {
